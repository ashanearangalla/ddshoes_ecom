...
<body>
    <div class="admin-panel">
        ...
        <h1>Add Order</h1>
            ...
            <div id="create-order" class="content-section">
                <form id="order-form" action="dbhandle/addOrder.php" method="POST">
                    ...
                    <button type="submit" class="button-main-2" >Add Order</button>
                </form>
            </div>
                                </div>
    </div>
